...
L'objectif final est d'observer la couverture du réseau dans l'appartement entier, afin d'ensuite optimiser le placement de la station de base pour maximiser cette couverture à une vitesse la plus élevée possible.% via des méthodes d'optimisation que l'on \TODO{verra plus loin}, tel que la méthode Monte-Carlo ou encore un algorithme génétique.
